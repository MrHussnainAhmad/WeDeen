...
export default function SettingsScreen() {
  ...
  const onToggleBackgroundLocation = (value: boolean) => {
    ...
    Alert.alert(
      ...
      'Muslim Deen: Quran & Prayer will check your location in the background — even when the app is closed — only to keep prayer times and the adhan accurate while you travel. Your location stays on your device and is never shared.',
      [
