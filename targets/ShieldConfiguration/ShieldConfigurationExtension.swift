...
class ShieldConfigurationExtension: ShieldConfigurationDataSource {
  ...
  private let appGroupIdentifier = "group.expo.app-blocker"

  // All values below are replaced by the config plugin at prebuild time
  private let shieldTitle = "Hold on!"
  private let shieldSubtitle = "{appName} is blocked."
  private let shieldPrimaryButtonLabel = "Earn Free Time"
  ...
  private let shieldPrimaryButtonColor = UIColor(red: 0.984, green: 0.380, blue: 0.027, alpha: 1.0)
